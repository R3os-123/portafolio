Root-me Write-up: GraphQL Introspection
Análisis Inicial
...
Resultado relevante: Aparte del objeto rockets, encontramos un objeto sospechoso llamado IAmNotHere que requiere un argumento obligatorio llamado very_long_id de tipo Int.
...
Al consultar el primer ID (very_long_id: 1), notamos que el servidor devuelve una sola letra. Esto indica que la flag está fragmentada a través de múltiples registros.
